...
calculateSalePrice() method in which returned price is calculated as following: if weight>2000 then returned price car
should include 10% discount, otherwise 20% discount.
The Sedan class has field as length and also does its own implementation of calculateSalePrice(): if length of
...
class Truck extends Car{
    ...
    public double calculateSalePrice() {
        ...
        else return super.calculateSalePrice()*80;
...
class CarTester{
    public static void main(String[] args) {
        Car [] arr = {new Sedan(25000,"Black",25), new Truck(30000,"White",2500)};
        for(Car x:arr){
